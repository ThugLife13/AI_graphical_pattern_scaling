...
void mainFrame::switchPhase(PHASE newPhase) {
    ...
    if (currentPhase == PREP) {
        ...
        leftSizer->Add(leftSubPanel, 0, wxEXPAND);
    ...
    if (currentPhase == AI_RECOGNITION) {
        ...
        startRecognition = new wxButton(leftPanel, wxID_ANY, wxT("Start Recognition"));
    ...
    if (currentPhase == AI_GENERATION) {
        ...
        leftSizer->Add(leftSubPanel1, 0, wxEXPAND);
        ...
        leftSizer->Add(leftSubPanel2, 0, wxEXPAND);
        ...
        newSizeX = new wxStaticText(leftSubPanel1, wxID_ANY, "New Size X (in px):", wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT);
        leftSubSizer1->Add(newSizeX, 0, wxALL, 10);
        ...
        nexSizeY = new wxStaticText(leftSubPanel2, wxID_ANY, "New Size Y (in px):", wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT);
        leftSubSizer2->Add(nexSizeY, 0, wxALL, 10);
        ...
        startGeneration = new wxButton(leftPanel, wxID_ANY, wxT("Start Generation"));
        leftSizer->Add(startGeneration, 0, wxALL, 10);
